...
def plot_surface_nodes(surf, df_data, df_yeo_surf, project_root):
    ...
    plot_surface_sphere(p, df_data['ChannelPosition_conte69_infl'], custom_cmap(norm(channel_integers)), screenshot_path)
...
def plot_surface_nodes_gradients(surf, df_data, df_yeo_surf, project_root):
    ...
    plot_surface_sphere(p, df['ChannelPosition_conte69_infl'], custom_cmap(norm(df['t1_gradient1'].values)), screenshot_path)
